      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            ...
            <p className="mt-1 text-sm text-gray-600">Fill out the form below to create a new course</p>
          </div>
          
          <form onSubmit={handleSubmit} className="px-6 py-6">
            {/* Basic Information Section */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-700 mb-4 pb-2 border-b border-gray-200">Basic Information</h2>
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-4 pb-2 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-700">Course Content</h2>
                <button
                  type="button"
                  onClick={addSection}
                                  ...
                                  <div className="flex items-start">
                                    <div className="flex-shrink-0 mt-1.5 mr-3">
                                      <div className="h-6 w-6 rounded-full bg-indigo-100 flex items-center justify-center">
                                        <span className="text-xs font-medium text-indigo-800">{j + 1}</span>
                                      </div>
                                    </div>
                                    <div className="flex-1">
                                      ...
                                      <RichTextEditor
                                        ...
                                        onChange={(val) => {
                                          const updated = [...sections];
                                          updated[i].lessons[j].description = val;
                                          setSections(updated);
                                        }}
                                      />
                                    </div>
