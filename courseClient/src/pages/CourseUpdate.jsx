...
const CourseUpdate = () => {
  ...
  useEffect(() => {
    ...
    // First, try to get from selectedCourse
    if (selectedCourse?.course) {
      currentCourse = selectedCourse.course;
      courseIndex = selectedCourse.index;
    }
    // If not available, find by courseId in courses array
    ...
    setLoading(false);
  }, [selectedCourse, courseId, courses, reset]);

  const addSection = () => {
    const currentSections = watchedValues.sections || [];
    setValue("sections", [
      ...currentSections,
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-6">
                    {watchedValues.sections?.map((section, i) => (
                      <div
                        key={i}
                    ...
                    {(!watchedValues.sections || watchedValues.sections.length === 0) && (
