...
const CourseMeta = ({
  ...
  const getCategoryColor = (category) => {
    const colors = {
      Programming: "bg-sky-100 text-sky-800 border-sky-200",
    ...
    return (
      colors[category] || "bg-purple-100 text-purple-800 border-purple-200"
    );
  };
      ...
      <div className="flex flex-col md:flex-row gap-4 sm:gap-6 items-center">
        ...
        <div className="space-y-4 w-full">
          ...
          {userRole === "student" && isEnrolled && (
            <div className="space-y-3 px-10 py-3 bg-green-50 rounded-lg border border-green-200">
